...
user1 = User.create(email: 'james@james.com', first_name: 'james', last_name: 'james', password: '123456')
...
25.times do
  i = 0
  group = Group.create(title: title[random_number], location: location[random_number], category: category[random_number], about: about[random_number], user_id: users[random_number].id)
  file = File.open("app/assets/images/groups/#{random_number_str}.jpg")
...
50.times do
  i = 0
  event = Event.create(title: event_title[random_number], location: event_location[random_number], body: body[random_number], group_id: groups[random_group], user_id: users[random_number], date_time: date_and_time[random_number])
